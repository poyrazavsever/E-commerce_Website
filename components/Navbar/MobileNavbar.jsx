    ...
    return (
        <div className='px-8 py-12 relative'>
            ...
            <div className='flex items-center justify-between'>
                <Link href="/">
                    <h2 className="text-2xl font-mono font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-neutral-800 to-amber-500">Sokak Butik</h2>
                </Link>
                ...
                <div>
                    ...
                    <div className={classNames({
                        ...
                        <div className='flex items-center justify-between'>
                            <div>
                                <h2 className="font-mono font-black text-3xl tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-neutral-800 to-amber-500">Sokak Butik</h2>
                            </div>

                            <button onClick={() => setIsOpen(false)}>
                                <Icon iconType="ai" iconName="AiOutlineCloseCircle" iconColor="text-amber-500 hover:text-amber-900" classname="text-3xl transition-all duration-300" />
                            </button>
                        </div>

                        <div className='h-[1px] w-full bg-amber-900 rounded-lg my-8'></div>
